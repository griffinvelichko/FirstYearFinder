...
public class FinderApp {
    ...
    private void init() {
        ...
        generalList.addStudent(beta1,false);
        generalList.addStudent(beta2, false);
        generalList.addStudent(beta3, false);
        generalList.addStudent(beta4,false);
        generalList.addStudent(beta5,false);
        generalList.addStudent(beta6, false);
    ...
    private void addStudent() {
        ...
        if (generalList.hasStudent(name)) {
            ...
            generalList.addStudent(new Student(name, residence, interest1, interest2, username), true);
        }
    }
